...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Cosanta-seeder\n"
...
static const string mainnet_seeds[] = {"m1.cosanta.net", "m2.cosanta.net", "dns.cosanta.io", "dns.cosa.is", ""};
static const string testnet_seeds[] = {"m1.cosanta.net", "m2.cosanta.net", "dns.cosanta.io", "dns.cosa.is", ""};
